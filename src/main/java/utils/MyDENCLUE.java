 ...
 * @author Haifeng Li
 */
public class MyDENCLUE extends PartitionClustering<double[]> {
    private static final Logger logger = LoggerFactory.getLogger(MyDENCLUE.class);
     ...
     */
    public MyDENCLUE(double[][] data, double sigma, int m) {
        if (sigma <= 0.0) {
